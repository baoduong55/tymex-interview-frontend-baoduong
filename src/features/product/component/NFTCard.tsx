...
const NFTCard = ({
  ...
  return (
    <div className="w-full  p-4 aspect-[267/365]  flex flex-col justify-between bg-[#2A2A2D] rounded-[10px] overflow-hidden" >
      ...
      <div className="flex items-center gap-2">
        <div className="relative">
          ...
          <div className={clsx("absolute -bottom-1 -right-1 w-4 h-4 bg-black rounded-full border-2 border-[#2A2A2D]",
            ...
            <Image src={`/assets/icons/status/${product.author.onlineStatus}.svg`} alt={product.author.onlineStatus} width={16} height={16} />
          </div>
        </div>
